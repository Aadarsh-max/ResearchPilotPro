...
const HomePage = () => {
  ...
  return (
    <div className="font-sans bg-[#FAFAFC] text-[#1F2937] overflow-hidden">
      ...
      bg-linear-to-br from-[#5B2A86] via-[#4C1D95] to-[#0EA5A4] 
      text-white px-4 sm:px-6 md:px-10 overflow-hidden"
      >
        ...
        <div className="relative text-center max-w-4xl z-10">
          ...
          font-bold mb-4 sm:mb-6 tracking-tight animate-fadeUp"
          >
          ...
          <p
            ...
            mb-6 sm:mb-8 opacity-90 leading-relaxed animate-fadeUp"
          ...
          <button
            ...
            className="bg-white text-[#5B2A86] font-semibold 
      ...
      <section className="py-14 sm:py-16 md:py-20 bg-[#F3F4F6] px-4 sm:px-6 md:px-16">
        <h2
          className="text-2xl sm:text-3xl md:text-4xl 
        font-bold text-center text-[#5B2A86] 
        mb-10 sm:mb-14 md:mb-16 animate-fadeUp"
        >
...
Includes abstract, methodology, and expected outcomes."
      ...
      text-center animated-gradient border border-black"
      >
        <FaBrain
          className="mx-auto text-3xl sm:text-4xl md:text-5xl 
        text-[#5B2A86] mb-4 sm:mb-6 animate-fadeUp"
        />

        <h2
          className="text-2xl sm:text-3xl md:text-4xl 
        font-bold text-[#0EA5A4] mb-4 sm:mb-6 animate-fadeUp"
        >
        ...
        <p
          ...
          font-semibold text-[#5B2A86] animate-fadeUp"
          style={{ animationDelay: "0.2s" }}
        >
...
const FeatureCard = ({ title, desc }) => (
  ...
  >
    ...
    font-semibold text-[#0EA5A4] mb-3 sm:mb-4"
    >
      {title}
    </h3>
    <p
